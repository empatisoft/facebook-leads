...
class Facebook {
    ...
    private $page_access_token = FACEBOOK_PAGE_ACCESS_TOKEN;
    private $page_id = FACEBOOK_PAGE_ID;
    private $client;
    ...
    /**
     * Sayfaya ait aktif formlar çekiliyor.
     */
    public function getForms($type = 'JSON') {
        ...
        $response = $this->client->request('GET', $this->baseUrl.'/'.$this->page_id.'/leadgen_forms', array('query' => $params));
    ...
    /**
     * İlgili forma ait başvurular alınıyor.
     */
    public function getLeads($form_id, $type = 'JSON') {
